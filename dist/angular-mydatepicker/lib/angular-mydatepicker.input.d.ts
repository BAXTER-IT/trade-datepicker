...
export declare class AngularMyDatePickerDirective implements OnChanges, OnDestroy, ControlValueAccessor, Validator {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<AngularMyDatePickerDirective, "[angular-mydatepicker]", ["angular-mydatepicker"], { "options": "options"; "locale": "locale"; "defaultMonth": "defaultMonth"; }, { "dateChanged": "dateChanged"; "inputFieldChanged": "inputFieldChanged"; "calendarViewChanged": "calendarViewChanged"; "calendarToggle": "calendarToggle"; "rangeDateSelection": "rangeDateSelection"; "viewActivated": "viewActivated"; }, never, never, false, never>;
}
