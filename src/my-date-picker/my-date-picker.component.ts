...
import {
    ...
    IMyMarkedDates, IMyMarkedDate, IMyDateFormat } from "./interfaces/index";
...
import {IMyBTNRow} from "./interfaces/my-right-btn-row.interface";
            ...
            if (i === 1) {
                ...
                for (let j = pm; j <= dInPrevM; j++) {
                    ...
                    week.push({dateObj: date, cmo: cmo, currDay: this.isCurrDay(j, m, y, cmo, today),
                        ...
                        labeledDate: this.utilService.isLabeledDate(date, this.opts.labelDates, this.opts.markWeekends),
